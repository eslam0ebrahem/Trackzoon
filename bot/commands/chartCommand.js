...
export const handleChartCommand = async (bot, chatId, productIdentifier = null) => {
  try {
...
`;
    ...
    console.error('Error in handleChartCommand:', error);
    await sendMessage(bot, chatId, '❌ An error occurred while generating the chart.');
  }
};

export default handleChartCommand;
