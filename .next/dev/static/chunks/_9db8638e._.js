...
function Home() {
    ...
    if ($[0] !== "cb4cdbc0b21db93517113e27d83d42d6948fcddc571036fcec52fc1f1ce2782a") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "cb4cdbc0b21db93517113e27d83d42d6948fcddc571036fcec52fc1f1ce2782a";
    }
    let t0;
    ...
    let t5;
    if ($[6] !== products) {
        t5 = products.map(_HomeProductsMap);
        $[6] = products;
        $[7] = t5;
    } else {
        t5 = $[7];
...
_s(Home, "bci7mCOSnVrtL1Tiqkn9DuoL2iY=");
_c = Home;
function _HomeProductsMap(product) {
