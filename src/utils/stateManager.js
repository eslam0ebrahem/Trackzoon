...
export const BotStates = {
  ...
  SETTING_MIN_DISCOUNT: 'SETTING_MIN_DISCOUNT',
  SETTING_QUIET_HOURS: 'SETTING_QUIET_HOURS',
  SETTING_DROP_PROBABILITY_THRESHOLD: 'SETTING_DROP_PROBABILITY_THRESHOLD',
  SETTING_AI_CONFIDENCE_BUY_NOW: 'SETTING_AI_CONFIDENCE_BUY_NOW',
  SETTING_AI_CONFIDENCE_WAIT: 'SETTING_AI_CONFIDENCE_WAIT',
