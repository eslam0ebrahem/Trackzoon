...
export default function ManageProductsPage() {
  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-4">
        <Link href="/dashboard/products/create" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md font-semibold transition-colors duration-200">
          Create New Product
        </Link>
      </div>
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <h2 className="text-xl font-semibold p-4 border-b border-gray-200">All Products</h2>
                ...
                <tr key={product._id} className="hover:bg-gray-50">
                  {editingProductId === product._id ? (
                    <>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{product.priceHistory.slice(-1)[0]?.price || 'N/A'}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <input
                          type="number"
                          name="thresholdPrice"
